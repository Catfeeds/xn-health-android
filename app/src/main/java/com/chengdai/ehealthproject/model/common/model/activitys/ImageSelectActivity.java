...
import com.chengdai.ehealthproject.uitls.CapturePhotoHelper;
import com.chengdai.ehealthproject.uitls.SystemUtils;
...
public class ImageSelectActivity extends Activity implements View.OnClickListener {
    ...
    protected void init() {
//        staticPath = getIntent().getStringExtra("path");
    ...
    public void onClick(View v) {
        ...
        try {
            switch (v.getId()) {
                case R.id.tv_take_capture:// 拍照
                    PermissionCheck(0); //6.0系统申请相机权限
                    break;
                case R.id.tv_alumb:// 相册选择
                    PermissionCheck(1);
                    break;
                case R.id.empty_view:// 取消
    ...
    private void PermissionCheck(int requestcode) {
        if (AppUtils.getAndroidVersion(Build.VERSION_CODES.M))  //如果运行环境是6.0
        {
            ...
            if (ContextCompat.checkSelfPermission(ImageSelectActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED ||
                    ...
                    ContextCompat.checkSelfPermission(ImageSelectActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED
